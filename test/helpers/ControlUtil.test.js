...
describe('ControlsParser', () => {
  describe('isAnyAncestorOrControlHasAddMore', () => {
    ...
    it('should return true when parentFormFieldPath is empty and control has addMore property with value true', () => {
      const control = {
        properties: {
          addMore: true,
        },
  ...
  describe('getCurrentFormFieldPathIfAddMore', () => {
    it('should return formFieldPath when parentFormFieldPath is not empty', () => {
      ...
      expect(result).toBe('Form.1/1-0/2-0');
    });

    it('should return formFieldPath when parentFormFieldPath is empty and control has addMore property is true', () => {
      const control = {
        id: 2,
        properties: {
          addMore: true,
