...
describe('SectionMapper', () => {
  ...
  describe('getInitialObject', () => {
    it('should return initial object when obs has no value', () => {
      ...
      expect(initObjectArray[0].formFieldPath).toBe(sectionControlFormFieldPath);
    });
    ...
    it('should return more than one obs when observations come from addMore controls', () => {
      ...
      expect(initObject.formFieldPath).toBe(sectionControlFormFieldPath);
    ...
    it('should return single initial object when segregatedObs is empty', () => {
      const sectionCtrl = {
        type: 'section',
        id: '1',
        controls: [obsControl],
    ...
    it('should handle observations with non-matching prefix in segregateObsByAddMoreSections', () => {
      const prefix = { formFieldPath: 'form.1/1' };
      const observations = [{
        formFieldPath: 'differentForm.1/2-0',
        concept,
      }];
